...
### Create momentum – don't sprint 创造动力 -- 不要冲刺
...
### Simple first, then powerful 先简单，后强大
...
### Set monthly, quarterly or/and annual roadmaps 设定月度、季度或/和年度路线图
...
### Connect daily work to larger goals with projects 用项目将日常工作与更大的目标联系起来
...
### Work in n-week cycles 以N周为迭代周期开展工作
...
### Keep a manageable backlog 保持一个可管理的待办列表
...
### Mix feature and quality work 混合功能和质量工作
...
### Specify project and issue owners 明确项目和任务的负责人
...
### Scope issues to be as small as possible 将问题的范围尽可能的小
...
### Measure progress with actual work 用实际工作来衡量进展
...
### Run cross-functional teams 运行跨职能的团队
